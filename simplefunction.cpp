 ...
 */
void SimpleFunction::updatelrstatistics (double *totallrnull, double *totallralternate, int start, int end) {
	for (int j = 0 ; j < n; j++){
 ...
 * current set of SNPs
 */
double SimpleFunction::getpower (double *totallrnull, double *totallralternate, int& start, int& end ) {
 ...
 */
void SimpleFunction::search_snps (double *totallrnull, double *totallralternate, int& start, int& end, int increment, double& power, double threshold) {
	gc ++;
 ...
 */
int SimpleFunction::find_exposed_snps_empirical ( ) {
	for (int j = 0 ; j < n; j++)
		totallrnull[j] = totallralternate[j] = 0;
 ...
 */
int SimpleFunction::find_exposed_snps_analytical () {
...
int main (int argc, char *argv[]){
	if (argc > 1) {
		SimpleFunction *sg = new SimpleFunction (argv[1]);
